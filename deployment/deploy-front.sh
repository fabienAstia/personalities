...
set -e
set -x
cd "/var/lib/jenkins/agent1/workspace/personalities-front-deployment/personalities-vue"
...
cp -r /var/lib/jenkins/agent1/workspace/personalities-front-deployment/personalities-vue/dist/* \
