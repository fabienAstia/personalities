...
nohup env BUILD_ID=dontKillMe java -jar "$DEPLOY_DIR/$JAR_NAME" --spring.profiles.active=prod --spring.config.additional-location="$SECRET_FILE" > "$DEPLOY_DIR/app.log" 2>&1 &
