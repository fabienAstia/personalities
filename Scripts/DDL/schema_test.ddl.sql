...
DROP TABLE IF EXISTS schema_test.t_evaluations, schema_test.t_strengths_and_weaknesses, schema_test.t_roles;
DROP TABLE IF EXISTS schema_test.t_mbti_types, schema_test.t_includes, schema_test.t_professions;
DROP TABLE IF EXISTS schema_test.t_matches, schema_test.t_psych_pref, schema_test.t_constraints;
DROP TABLE IF EXISTS schema_test.t_users, schema_test.t_questions, schema_test.t_answers;

CREATE TABLE schema_test.t_evaluations(
...
CREATE TABLE schema_test.t_strengths_and_weaknesses (
	id int GENERATED ALWAYS AS IDENTITY,
	...
	CONSTRAINT t_strengths_and_weaknesses_evaluation_id FOREIGN KEY (evaluation_id)
		REFERENCES schema_test.t_evaluations(id)
);

CREATE TABLE schema_test.t_psych_pref(
	id int GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE schema_test.t_constraints(
	id int GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE schema_test.t_mbti_types(
	id int GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE schema_test.t_professions(
	id int GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE schema_test.t_matches(
	mbti_type_id int NOT NULL,
	...
	CONSTRAINT t_matches_profession_fk FOREIGN KEY (profession_id)
		REFERENCES schema_test.t_professions(id),
	CONSTRAINT t_matches_uk PRIMARY KEY (mbti_type_id, profession_id)
);

CREATE TABLE schema_test.t_users (
	id int GENERATED ALWAYS AS IDENTITY,
	...
	CONSTRAINT t_users_role_fk FOREIGN KEY (role_id)
		REFERENCES schema_test.t_roles(id),
	CONSTRAINT t_users_mbti_type_id FOREIGN KEY (mbti_type_id)
		REFERENCES schema_test.t_mbti_types (id)
);

CREATE TABLE schema_test.t_questions (
	id int GENERATED ALWAYS AS IDENTITY,
	...
	CONSTRAINT t_questions_constraints_fk FOREIGN KEY (constraint_id)
		REFERENCES schema_test.t_constraints(id),
	CONSTRAINT t_questions_psych_pref_fk FOREIGN KEY (psych_pref_id)
		REFERENCES schema_test.t_psych_pref (id)
);

CREATE TABLE schema_test.t_answers(
	id int GENERATED ALWAYS AS IDENTITY,
	rating int NOT NULL,
	...
	CONSTRAINT t_answers_users_fk FOREIGN KEY (user_id)
		REFERENCES schema_test.t_users(id),
	CONSTRAINT t_answers_questions_fk FOREIGN KEY (question_id)
		REFERENCES schema_test.t_questions(id),
